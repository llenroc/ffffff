                ...
                actions: {
                    ...
                    display: function (data) {
                        ...
                        if (_permissions.changeTexts) {
                            $('<a href="' + abp.appPath + "AppAreaName/Languages/Texts?languageName=" + data.record.name + '" class="btn btn-default btn-xs" title="' + app.localize('ChangeTexts') + '"><i class="fa fa-bars"></i></a>')
                                .appendTo($span)
                                .click(function () {
